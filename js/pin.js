...
(function () {
  ...
  // функция которая копирует начинку шаблона, добавляет свойства/стили/значения атрибутов к элементам внутри шаблона и формирует элемент
  ...
  // функция, которая получает в параметр данные с сервера, устанавливает количество отображаемых меток, удаляет старые метки и отрисовывает новые
